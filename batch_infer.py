...
def eval_model(args):
    ...
    for line in tqdm(questions[0:2]):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="screenspot/screenspot_imgs/")
    parser.add_argument("--question-file", type=str, default="ScreenSpot/gpt-4o_query.jsonl")
    parser.add_argument("--answers-file", type=str, default="./answer_screenspot.jsonl")
